    ...
    return (
      <form className="w-50" onSubmit={handleSubmit}>
        ...
        <div className="form-group">
          ...
          <select className="form-control" id="exampleFormControlSelect1" onChange={handleCountryChange} defaultValue={employee.country}>
        ...
        <div className="form-group">
          ...
          <select className="form-control" id="exampleFormControlSelect1" onChange={e=> updateEmp({...employee , city: e.target.value})} defaultValue={employee.city}>
            { cities ?  cities.map((v,i) => <option key={i+1} value={v.code} >{v.name}</option>) : <option>No Valid Option</option>}
          </select>
        </div>
        
        <div className="form-check">
        <input type="checkbox" className="form-check-input" defaultChecked={employee.isSingle}  onChange={e=> updateEmp({...employee , isSingle: e.target.value === 'on'})}/>
          <label htmlFor="exampleFormControlTextarea1" className="form-check-label">Is Single
